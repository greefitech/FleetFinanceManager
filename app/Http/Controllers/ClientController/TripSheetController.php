...
class TripSheetController extends Controller
{
    ...
    public function DefaultTripSheet($tripId){    //Default Trip Sheet
        ...
        @$Data['otherExpenses'] =  $this->Expense::where([['expense_type','!=',2],['expense_type','!=',1],['expense_type','!=',3],['expense_type','!=',4],['expense_type','!=',5],['expense_type','!=',6],['expense_type','!=',11],['expense_type','!=',12],['expense_type','!=',13],['tripId',$tripId],['status',1]])->orderBy('date')->get();
