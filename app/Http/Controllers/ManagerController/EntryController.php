...
class EntryController extends Controller
{
    ...
    public function add(){
        return view('manager.trip.entry.add');
    }
    ...
    public function save(){
        ...
        try {
            ...
            if(!empty(request()->customerId)){
                ...
                $CustomerData=Customer::where([['clientid',auth()->user()->owner->id],['mobile',request('customerMobile')]])->first();
                if(!empty($CustomerData->mobile)){
                    ...
                    $customer->clientid=auth()->user()->owner->id;
            ...
            $entry->clientid=auth()->user()->owner->id;
            $entry->managerid=auth()->user()->id;
            $entry->save();
    ...
    public function edit($id){
        try {
            ...
            return view('manager.trip.entry.edit',$Data);
        }catch (Exception $e){
            return back()->with('danger','Something went wrong!');
        }
    }
    ...
    public function update($id){
        ...
        try {
            ...
            $entry->managerid=auth()->user()->id;
            $entry->save();
            return redirect(route('manager.ViewTripEntryList',request('tripId')))->with('success',['Entry','Updated Successfully!']);
        }catch (Exception $e){
            return back()->with('danger','Something went wrong!');
        }
    }
    ...
    public function delete($id){
        ...
        try {
            ...
            $Entry = Entry::findOrfail($id);
            $Entry->delete();
            return redirect(route('manager.ViewTripEntryList',$Entry->tripId))->with('success',['Entry','Deleted Successfully!']);
        }catch (Exception $e){
            return back()->with('danger','Something went wrong!');
        }
    }
