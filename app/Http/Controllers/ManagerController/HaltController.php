...
class HaltController extends Controller
{
    ...
    public function add(){
        return view('manager.trip.halt.add');
    }
    ...
    public function save(){
        ...
        try {
            ...
            $Halt->save();
            return redirect(route('manager.AddHalt'))->with('success',['Halt','Added Successfully!']);
        }catch (Exception $e){
    ...
    public function update($id){
        ...
        try {
            ...
            $Halt->clientid=auth()->user()->id;
            $Halt->save();
            return redirect(route('manager.ViewTripHaltList',request('tripId')))->with('success',['Halt','Updated Successfully!']);
        }catch (Exception $e){
            return back()->with('danger','Something went wrong!');
        }
    }
