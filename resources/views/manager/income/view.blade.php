            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach(auth()->user()->incomes as $Income)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('manager.DeleteIncome',$Income->id) }}" method="POST">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="_method" value="DELETE">
                                                <a href="{{ route('manager.EditIncome',$Income->id) }}" class="btn"><i class="fa fa-pencil text-aqua"></i></a>
                        ...
                        @else
                            <blockquote><p>No Income till now added!!</p></blockquote>
                        @endif
                    </div>
                </div>
            </div>
