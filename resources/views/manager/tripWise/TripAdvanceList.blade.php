                                ...
                                <tbody>
                                    @foreach($TripAdvances as $TripAdvance)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('manager.DeleteTripAdvance',$TripAdvance->id) }}" method="POST">
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <a href="{{ route('manager.EditTripAdvance',$TripAdvance->id) }}" class="btn"><i class="fa fa-pencil text-aqua"></i></a>
