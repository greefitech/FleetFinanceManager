        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none;">
                    ...
                    <li><a href="{{ url('/manager/expense-types') }}"><i class="fa fa-user <?php echo $color[array_rand($color,1)] ?>"></i> <span>Expense / Income Type</span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none;">
                    ...
                    <li><a href="{{ action('ManagerController\TripAdvanceController@create') }}"><i class="fa fa-shield <?php echo $color[array_rand($color,1)] ?>"></i> <span>Add Trip Advance</span></a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none;">
                    <li><a href="{{ action('ManagerController\ReportController@create') }}"><i class="fa fa-user <?php echo $color[array_rand($color,1)] ?>"></i> <span>Expense Report</span></a></li>
                </ul>
            </li>
        </ul>
    </section>
