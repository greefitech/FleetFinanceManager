            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ auth()->user()->profile_image? url(auth()->user()->profile_image) :'/assets/img/greefi.jpg'  }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{{ auth()->user()->transportName }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ auth()->user()->profile_image? url(auth()->user()->profile_image) :'/assets/img/greefi.jpg'  }}" class="img-circle" alt="User Image">
                            <p>
